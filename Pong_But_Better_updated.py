...
ch = int(input("Enable Kuksa.val databroker? 1=yes 0=no"))
if ch == 1:
...
while run:
    ...
    if databroker_enabled:
        #get brake signal to move right player up
        current_values = client.get_current_values(['Vehicle.Chassis.Brake.PedalPosition','Vehicle.Chassis.Accelerator.PedalPosition'])
        if current_values['Vehicle.Chassis.Brake.PedalPosition'] is not None:
            #print(current_values['Vehicle.Chassis.Brake.PedalPosition'].value)
            if current_values['Vehicle.Chassis.Brake.PedalPosition'].value > 20:
        ...
        #get throttle signal to move right player down
        #current_values = client.get_current_values(['Vehicle.Chassis.Accelerator.PedalPosition'])
        #if current_values['Vehicle.Chassis.Accelerator.PedalPosition'] is not None:
        #    if current_values['Vehicle.Chassis.Accelerator.PedalPosition'].value > 50:
        #        print('Acc: ' + str(current_values['Vehicle.Chassis.Accelerator.PedalPosition'].value))
        #        right_paddle_vel = 0.9
        #        second_right_paddle_vel = 0.9
        #    elif current_values['Vehicle.Chassis.Accelerator.PedalPosition'].value <= 50 :
        #        right_paddle_vel = 0
        #        second_right_paddle_vel = 0
